...
class SearchResultDtoTest extends Specification {
    static class SubDto extends SearchResultDto{
        @Override
    ...
    def setup() {
        testClass = SearchResultDto.class
    }
    ...
    def "toString 확인"(){
        expect:
        ToStringVerifier.forClass(testClass).containsClassName(new SearchResultDto())
    }
}
